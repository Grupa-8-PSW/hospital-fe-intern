...
import { BloodRequestDoctorViewComponent } from "./modules/blood/blood-request-doctor-view/blood-request-doctor-view.component";
...
const routes: Routes = [
  ...
  { path: 'bloodBanks/urgent', component: UrgentRequestComponent, canActivate: [AuthGuard, RoleGuard], data: { roles: ['Manager'] }},
  { path: 'examinations/do', component: DoExaminationComponent}, //role doctor
  { path: 'blood/bloodRequestDoctorView', component: BloodRequestDoctorViewComponent} //role doctor
];
